...
dernière version : fr-simplecode0.4 (! récent, pas beaucoup de modification par rapport à la 0.3 et en développement, le fichier change régulièrement et n'est pas forcément stable !) (actuellement 13473 lignes de code C)
<br>nouveauté :<br>
